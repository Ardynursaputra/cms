...
<head>
	...
	<!-- Favicon icon -->
	<link rel="icon" type="<?= base_url('assets/adminmart/')?>image/png" sizes="16x16" href="assets/images/favicon.png">
    ...
    <![endif]-->
	<script src="https://cdn.tiny.cloud/1/d4da852b0gb4v6pu49ekduq2sqbz3qbjuk8297n59wpxij4j/tinymce/6/tinymce.min.js"
...
<body>
				...
				<div class="navbar-header" data-logobg="skin6">
					...
					<div class="navbar-brand">
						...
						<a href="<?= base_url('');?>">
							<b class="logo-icon">
								<!-- Dark Logo icon -->
								<img src="<?= base_url('assets/adminmart/')?>assets/images/logo-icon.png" alt="homepage"
									class="dark-logo" />
								<!-- Light Logo icon -->
								<img src="<?= base_url('assets/adminmart/')?>assets/images/logo-icon.png" alt="homepage"
									class="light-logo" />
							...
							<span class="logo-text">
								<!-- dark Logo text -->
								<img src="<?= base_url('assets/adminmart/')?>assets/images/logo-text.png" alt="homepage"
									class="dark-logo" />
								<!-- Light Logo text -->
				...
				<ul class="navbar-nav float-right">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
							...
							<img src="assets/images/users/profile-pic.jpg" alt="" class="rounded-circle" width="40">
							<span class="ml-2 d-none d-lg-inline-block"><span>Hello</span> <span
									class="text-dark">Ardy</span>
		...
		<div class="scroll-sidebar" data-sidebarbg="skin6">
			...
			<nav class="sidebar-nav">
				<ul id="sidebarnav">
					...
					<li class="sidebar-item <?php if($menu=='home'){ echo "active"; } ?>"> <a
							class="sidebar-link sidebar-link" href="<?= base_url('admin/home')?>"
							aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span
								class="hide-menu">Dashboard</span></a></li>
					<li class="sidebar-item <?php if($menu=='caraousel'){ echo "active"; } ?>"> <a class="sidebar-link"
							href="<?= base_url('admin/caraousel')?>" aria-expanded="false"><i data-feather="tag"
								class="feather-icon"></i><span class="hide-menu">Caraousel</span></a></li>
					<li class="sidebar-item <?php if($menu=='kategori'){ echo "active"; } ?>"> <a
							class="sidebar-link sidebar-link" href="<?= base_url('admin/kategori')?>"
							aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span
								class="hide-menu">Kategori
								konten</span></a></li>
					<li class="sidebar-item <?php if($menu=='konten'){ echo "active"; } ?>"> <a
							class="sidebar-link sidebar-link" href="<?= base_url('admin/konten')?>"
							aria-expanded="false"><i data-feather="calendar" class="feather-icon"></i>
							<spanclass="hide-menu">Konten</span>
						</a></li>
					...
					<li class="sidebar-item <?php if($menu=='konfigurasi'){ echo "active"; } ?>"> <a
							class="sidebar-link sidebar-link" href="<?= base_url('admin/konfigurasi')?>"
	...
	<script src="<?= base_url('assets/adminmart/')?>assets/libs/perfect-scrollbar/dist/perfect-scrollbar.jquery.min.js">
	</script>
	...
	<script
		src="<?= base_url('assets/adminmart/')?>assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.min.js">
	</script>
	<script src="<?= base_url('assets/adminmart/')?>assets/extra-libs/jvector/jquery-jvectormap-2.0.2.min.js"></script>
	<script src="<?= base_url('assets/adminmart/')?>assets/extra-libs/jvector/jquery-jvectormap-world-mill-en.js">
	</script>
