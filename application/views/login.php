...
<body>
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            style="background:url(<?= base_url('assets/adminmart/')?>assets/images/big/auth-bg.jpg) no-repeat center center;">
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url('https://ecs7.tokopedia.net/img/cache/700/product-1/2020/7/12/2839258/2839258_deb21d7f-99e2-4ed8-815a-dd201bed5161_1200_1200.jpg');">
                </div>
